...
// window.madeItToLastSlide = false;
...
( function( document, window ) {
    ...
    var goto = function( event ) {
        ...
        /*if(event.target.id == "step-1" && event.detail && event.detail.next && event.detail.next.id == "step-4" && window.madeItToLastSlide == false)
        {

debugger;            return;
        }
        if(event.target.id == "step-4")
        {
            window.madeItToLastSlide = true;
        }*/
